class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:group, :verified, :admin, :id, :username, :password_digest, :surname, :givenname, :nickname, :birthdate_time, :spreadsheet_link, :email, :sheet_name)
    end
